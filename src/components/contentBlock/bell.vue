<template>
  <div class="bell-wrapper">
    <div class="bell-title-line">
      ...
      <ul class="bell-nav">
        <li :class="{ 'bell-active': selectedNav === bellNav }" v-for="bellNav in bellNavs" @click="selectedNav = bellNav" :key="bellNav"><a>{{ bellNav }}</a></li>
      </ul>
    ...
    <div class="bell-content">
      <bell-item v-for="bellIndex in 3" :key="bellIndex" class="bell-item-margin"></bell-item>
    </div>
  </div>
</template>

<script>
import bellItem from '../common/bellItem'
export default {
  data () {
    return {
      bellNavs: ['来电', '短信', '闹铃'],
